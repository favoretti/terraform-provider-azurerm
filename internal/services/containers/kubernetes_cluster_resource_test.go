...
func (t KubernetesClusterResource) Exists(ctx context.Context, clients *clients.Client, state *pluginsdk.InstanceState) (*bool, error) {
	...
	resp, err := clients.Containers.ManagedClustersClient.Get(ctx, *id)
	if err != nil {
...
func (KubernetesClusterResource) updateDefaultNodePoolAgentCount(nodeCount int) acceptance.ClientCheckFunc {
	return func(ctx context.Context, clients *clients.Client, state *pluginsdk.InstanceState) error {
		...
		nodePoolId := agentpools.NewAgentPoolID(clients.Account.SubscriptionId, resourceGroup, clusterName, nodePoolName)
		nodePool, err := clients.Containers.AgentPoolsClient.Get(ctx, nodePoolId)
		if err != nil {
		...
		if nodePool.Model.Properties == nil {
		...
		err = clients.Containers.AgentPoolsClient.CreateOrUpdateThenPoll(ctx, nodePoolId, *nodePool.Model)
		if err != nil {
